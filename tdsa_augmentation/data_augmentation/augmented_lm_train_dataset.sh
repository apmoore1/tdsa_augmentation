...
echo "Laptop"
python tdsa_augmentation/data_augmentation/lm_expander_data_creator.py ./resources/data_augmentation/target_words/restaurant_train_expanded.json ./resources/language_models/yelp_model.tar.gz ./data/original_restaurant_sentiment/train. ./data/augmented_train/laptop.json --cuda
echo "Restaurant"
